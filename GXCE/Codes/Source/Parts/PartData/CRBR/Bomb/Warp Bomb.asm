...
PartDescription:
    String|
"Fires a bomb that immediately
appears at the target. It
detonates after a set time, and
never by proximity.
...
half [1] 0 #Explosion Trigger Radius
#################
## Ground Shot ##
#################
byte [2] |
